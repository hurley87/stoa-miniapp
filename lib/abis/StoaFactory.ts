...
export const STOA_FACTORY_ADDRESS: Address =
  '0x56Ee1dAb5b0CB673D25C4893FBE8253b08112658';
...
export const STOA_FACTORY_ABI = [
  {
    inputs: [
      ...
      { internalType: 'address', name: '_protocolRegistry', type: 'address' },
    ],
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'contract StoaProtocol', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
